...
Skill(skill="{xunji_training_skill_name}", args={
  ...
  "title": "练胸日",
  "body_part": "胸部",
  "client_request_id": "jianshen-zhushou-YYYYMMDD-body_part_pinyin-uuid",
  "plan": {
    "movements": [
      {
        "name": "杠铃卧推",
...
- `client_request_id`：`jianshen-zhushou-{datestr}-{body_part_pinyin}-{plan_hash}`，同一 datestr + body_part + plan_hash 必须相同。`plan_hash` 取计划内容的短哈希或 8 位随机字符。
...
```
jianshen-zhushou-{datestr}-{body_part_pinyin}-{plan_hash}
```
  ...
  "records": [
    {
      ...
      "body_part": "胸部",
      "localid": 123456,
      "client_request_id": "jianshen-zhushou-20260822-xiongbu-uuid",
      "title": "练胸日",
