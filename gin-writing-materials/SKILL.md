...
- [ ] Step 1 定位/创建项目文件夹 [自动]
- [ ] Step 2 生成主题定义并确认读者/文体/方向 [硬闸门]
- [ ] Step 3 拉取锚点素材到成品库 [自动]
- [ ] Step 4 选择本次挖掘域 [需确认]
- [ ] Step 5 对话挖掘素材 [硬闸门] [可回环]
- [ ] Step 6 完整性校验 [自动]
- [ ] Step 7 生成素材文档 [自动]
- [ ] Step 8 输出素材文档路径 [需确认]
```
...
```text
⚠️ 当前阻塞：等待你确认主题定义（Step 2 生成主题定义并确认读者/文体/方向）

你可以：
- 输入 "OK" 或 "确认" 继续
- 输入 "修改" 回退到 Step 1 重新定位项目
```
