#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""xie-zuo-su-cai 公共工具层：配置读取、路径解析、文本处理。"""
...
XIE_ZUO_SU_CAI_DIR = ".xie-zuo-su-cai"
...
def user_config_path():
    ...
    return os.path.join(home, ".config", "xie-zuo-su-cai", "config.yaml")
...
def tools_config_path(tools_dir=None):
    ...
    if not tools_dir:
        return None
    return os.path.join(os.path.expanduser(tools_dir), "xie-zuo-su-cai", "config.yaml")
