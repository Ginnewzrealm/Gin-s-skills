...
```bash
python3 /home/user/.claude/skills/skill-creator/scripts/quick_validate.py /home/user/.agents/skills/xie-zuo-su-cai
```
...
```bash
cd /home/user/.agents/skills/xie-zuo-su-cai
...
| session.py | material_root, topic | `.xie-zuo-su-cai/sessions/{topic}.json` |
| fragment.py | 5 字段素材数据 | `.xie-zuo-su-cai/fragments/{topic}/{日期}-{序号}.md` |
