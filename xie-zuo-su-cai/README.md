...
```bash
cp -r xie-zuo-su-cai ~/.agents/skills/
```

## 初始化

```bash
python3 ~/.agents/skills/xie-zuo-su-cai/scripts/init.py --material-root ~/Documents/写作素材库
```
...
备份会写入 `{tools-backup-dir}/xie-zuo-su-cai/config.yaml`。
