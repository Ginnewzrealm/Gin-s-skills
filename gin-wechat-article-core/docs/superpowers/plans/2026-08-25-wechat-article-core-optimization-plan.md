# gin-wechat-article-core 优化实现计划
...
**架构：** `gin-wechat-article-core` 主编排层新增 `role_boundary` 阻塞式确认阶段，新增 `narrative_protocol` 和结构化的 `materials_summary` 上下文字段；`style_selector.py` 完整读取 `.md` 素材并持久化到 `materials_full.md`；`template_loader.py` 从 YAML 模板提取 `narrative_protocol`；新增 `references/expansion-methodology.md`、`references/ai-flavor-guide.md`、`references/writing-checklist.md` 作为跨 skill 共享知识库；`gin-wechat-article-clarify`、`gin-wechat-article-angle`、`gin-wechat-article-outline`、`gin-wechat-article-writer`、`gin-wechat-article-polish`、`gin-wechat-article-title`、`gin-wechat-article-quality` 消费该协议和方法论；`config.yaml` 增加素材递归开关。
...
| 文件 | 职责 |
|------|------|
| `gin-wechat-article-core/scripts/style_selector.py` | 扫描素材、完整读取 `.md`、生成结构化摘要、持久化 `materials_full.md` |
| `gin-wechat-article-core/scripts/template_loader.py` | 加载 YAML 模板、校验、新增 `extract_narrative_protocol()` |
| `gin-wechat-article-core/config.yaml` | 增加 `materials.recursive` 与 `materials.extensions` 配置 |
| `gin-wechat-article-core/SKILL.md` | 更新 stage 流程、上下文协议、role_boundary 说明、输出目录、持久化、版本自检 |
| `gin-wechat-article-core/references/expansion-methodology.md` | 新增：核心原则、材料优先、说话位置、内容骨架、中文句法纪律 |
| `gin-wechat-article-core/references/ai-flavor-guide.md` | 新增：四层 AI 味模型、六种 AI 味诊断、24 种 AI 写作模式 |
...
| `gin-wechat-article-outline/SKILL.md` | 输入增加 `narrative_protocol` 和 `expansion-methodology.md`，按协议生成带素材映射的大纲 |
| `gin-wechat-article-writer/SKILL.md` | 输入增加 `narrative_protocol`、`expansion-methodology.md`、`writing-checklist.md`、`writing-style.md`（精简版）；删除 AI 角色边界、四层自检、卡兹克个人风格绑定；新增"扩写纪律"小节；frontmatter 保留 `narrative_protocol.derived_from` |
...
| `gin-wechat-article-quality/SKILL.md` | 读取 `narrative_protocol.forbidden_zone`、`ai-flavor-guide.md`、`writing-checklist.md`、`writing-style.md`（完整版），增加内容债/语言债诊断 |
| `gin-wechat-article-core/tests/test_style_selector.py` | 更新测试：完整读取、结构化摘要、递归开关 |
| `gin-wechat-article-core/tests/test_template_loader.py` | 新增测试：`extract_narrative_protocol()` |
| `gin-wechat-article-core/tests/test_core_stages.py` | 更新测试：移除 `polish_confirmed`，新增 `role_boundary` |
...
**文件：**
- 修改：`gin-wechat-article-core/scripts/style_selector.py`
- 修改：`gin-wechat-article-core/tests/test_style_selector.py`
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-core
...
```python
# gin-wechat-article-core/scripts/style_selector.py
...
**文件：**
- 修改：`gin-wechat-article-core/scripts/template_loader.py`
- 修改：`gin-wechat-article-core/tests/test_template_loader.py`
...
```python
# gin-wechat-article-core/scripts/template_loader.py
...
**文件：**
- 修改：`gin-wechat-article-core/config.yaml`
...
**文件：**
- 创建：`gin-wechat-article-core/references/expansion-methodology.md`
- 创建：`gin-wechat-article-core/references/ai-flavor-guide.md`
- 创建：`gin-wechat-article-core/references/writing-checklist.md`
...
> 消费方：`gin-wechat-article-writer`、`gin-wechat-article-quality`、`gin-wechat-article-polish`
...
### 任务 5：更新 `gin-wechat-article-core/SKILL.md`
...
| outline_selected | 分段写正文 | gin-wechat-article-writer | AI |
| draft_written | 二次改写正文 | （人工） | 人工 |
| draft_revised | 小标题优化 + 润色 | gin-wechat-article-polish | AI |
| polished | 提炼标题候选 | gin-wechat-article-title(article) | AI |
...
### 任务 6：更新 `gin-wechat-article-clarify/SKILL.md`
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-clarify
git add SKILL.md
...
### 任务 7：更新 `gin-wechat-article-angle/SKILL.md`
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-angle
git add SKILL.md
...
### 任务 8：更新 `gin-wechat-article-outline/SKILL.md`
...
- `context.md.narrative_protocol`（新增）
- `context.md.materials_summary.materials_path` 指向的 `materials_full.md`（新增）
- `gin-wechat-article-core/references/expansion-methodology.md`（新增）
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-outline
git add SKILL.md
...
### 任务 9：更新 `gin-wechat-article-writer/SKILL.md`

**文件：**
- 修改：`gin-wechat-article-writer/SKILL.md`

**目标：**
- 名字保留 `gin-wechat-article-writer`，但不再绑定卡兹克个人风格。
...
- `gin-wechat-article-core/references/expansion-methodology.md`（新增，精简执行版）
- `gin-wechat-article-core/references/writing-checklist.md`（新增，精简执行版）
- `gin-wechat-article-core/references/writing-style.md`（新增，精简执行版）：通用活人感写作原则
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-writer
git add SKILL.md
git commit -m "docs(gin-wechat-article-writer): 去卡兹克风格绑定，按 narrative_protocol 和通用扩写纪律写作"
```

---

### 任务 10：更新 `gin-wechat-article-polish/SKILL.md`
...
- `context.md.narrative_protocol`（新增）
- `gin-wechat-article-core/references/ai-flavor-guide.md`（新增）
- `gin-wechat-article-core/references/writing-checklist.md`（新增）
- `gin-wechat-article-core/references/writing-style.md`（新增）
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-polish
git add SKILL.md
...
### 任务 11：更新 `gin-wechat-article-title/SKILL.md`
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-title
git add SKILL.md
...
### 任务 12：更新 `gin-wechat-article-quality/SKILL.md`
...
- `gin-wechat-article-core/references/ai-flavor-guide.md`（新增，完整验收版）
- `gin-wechat-article-core/references/writing-checklist.md`（新增，完整验收版）
- `gin-wechat-article-core/references/writing-style.md`（新增，完整验收版）
...
```bash
cd /home/user/.claude/skills/agents-bridge/skills/gin-wechat-article-quality
git add SKILL.md
...
**文件：**
- 修改：`gin-wechat-article-core/tests/test_core_stages.py`
...
**文件：**
- 修改：`gin-wechat-article-core/SKILL.md`
- 可选创建：`gin-wechat-article-core/scripts/state_persistence.py`
...
```python
# gin-wechat-article-core/scripts/state_persistence.py
...
**文件：**
- 修改：`gin-wechat-article-core/SKILL.md`
- 可选创建：`gin-wechat-article-core/scripts/update_checker.py`
...
```python
# gin-wechat-article-core/scripts/update_checker.py
...
| gin-wechat-article-writer 删除重复角色边界 | 任务 9 |
| gin-wechat-article-writer 删除重复四层自检 | 任务 9 |
| gin-wechat-article-writer 删除卡兹克个人风格绑定 | 任务 9 |
...
**计划已完成并保存到 `docs/superpowers/plans/2026-08-25-gin-wechat-article-core-optimization-plan.md`。两种执行方式：**
