...
Python 测试需要 pytest，涵盖七项头部信息、岗位匹配置顶、全文小标题、紧接字段与技能分组、完整教育记录、三主题普通/编辑版和缺项拦截：
...
- 打印测试覆盖三种主题、编辑/保存态、短文/多页内容，并核对页面安全内边距、长内容换行和技能区跨页规则；设置 `PDF_OUT` 可导出 12 份模拟 PDF，以便检查页数、文本完整性及尾页。
